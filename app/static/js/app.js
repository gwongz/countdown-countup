...
var $, AppLayer, CountBox, CountForm, React, SetIntervalMixin, Timer, TimerButton;
...
Timer = React.createClass({
  ...
  getInitialState: function() {
    return this.calculateTime(this.props.data.occurs);
  },
  calculateTime: function(futureTime) {
    var days, diff, hours, milliseconds, minutes, now, seconds, secondsPerDay, secondsPerYear;
  ...
  componentDidMount: function() {
    return this.setInterval(this.tick, 100);
  },
  ...
  render: function() {
    var ago, countdown, days, msg, years;
    countdown = this.props.countdown;
    msg = countdown ? 'happens in' : 'happened';
    ago = !countdown ? 'ago' : '';
    years = parseInt(this.state.days / 365);
    days = years ? this.state.days % 365 : this.state.days;
    return React.createElement("div", {
      "className": "timer"
    }, React.createElement("h1", null, this.props.data.title, " ", msg), React.createElement("span", null, years, " years "), React.createElement("span", null, days, " days "), React.createElement("span", null, this.state.hours, " hours "), React.createElement("span", null, this.state.minutes, " minutes "), React.createElement("span", null, this.state.seconds, ".", this.state.milliseconds, " seconds "), ago, React.createElement("div", {
      "className": "submitDiv"
...
CountForm = React.createClass({
  handleSubmit: function(e) {
    ...
    return this.refs.occurs.getDOMNode().value = '';
  },
  resetError: function() {
    return $('.countError').text('');
  },
  render: function() {
    var currentYear, pi, question;
    question = this.props.countdown ? 'What are you counting down to?' : 'What are you counting up from?';
    ...
    return React.createElement("form", {
    ...
    }, React.createElement("h1", null, question), React.createElement("input", {
      "type": "text",
      "name": "title",
      "ref": "title",
      ...
      "for": "title"
    }, "Name of event"), React.createElement("input", {
      "type": "text",
      "ref": "occurs",
      "name": "occurs",
      "onClick": this.resetError
      ...
      "for": "occurs"
    }, this.props.msg), React.createElement("div", {
...
CountBox = React.createClass({
  ...
  render: function() {
    ...
    if (this.state.counting) {
      ...
      msg = this.state.countdown ? 'Happens on' : 'Happened';
      return React.createElement(CountForm, {
        "countdown": this.state.countdown,
        "msg": msg,
...
AppLayer = React.createClass({
  ...
  render: function() {
    var action;
    action = this.state.countdown ? 'Count up' : 'Count down';
    return React.createElement("div", {
      "className": "appLayer",
      "key": this.state.count
    }, React.createElement("p", {
      "onClick": this.toggleView
    }, action, " instead"), React.createElement("div", {
      "className": "countBox"
    }, React.createElement(CountBox, {
      "countdown": this.state.countdown
    })));
  }
});
...
},{"jquery":2,"react":148}],151:[function(require,module,exports){
var $;

$ = require('jquery');

$(function() {
  var randomColor, randomEames;
  console.log('Jquery ready');
  randomColor = function() {
    var colors;
    colors = ['#d09cdd', '#f0a748', '#6ab5b1', '#cd251f', '#78595e', '#51b355'];
    return $('.countBox').css({
      'background-color': colors[Math.floor(Math.random() * colors.length)]
    });
  };
  randomEames = function() {
    var colors;
    colors = ['#76A2B1', '#AD573D', '#DBD294', '#E5514C', '#B7C559'];
    return $('.countBox').css({
      'background-color': colors[Math.floor(Math.random() * colors.length)]
    });
  };
